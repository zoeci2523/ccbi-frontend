export default {
  ...
  'pages.login.accountLogin.errorMessage': 'Wrong username and password(ccbi-test/ccbi-cool)',
  'pages.login.failure': 'Sign in failed, please try again!',
  'pages.login.success': 'Sign in successfully!',
